      ...
      <div className="max-w-md w-full text-center thank-you-card">
        <div className="bg-card rounded-2xl border border-border p-8 sm:p-10 shadow-lg">
          ...
          <a
            ...
            className="thank-you-btn flex items-center justify-center gap-2 w-full py-3.5 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 active:scale-[0.98] transition-all duration-200 text-sm tracking-wide uppercase mb-3"
          >
          ...
          <Link
            href="/"
            className="thank-you-btn block w-full py-3.5 bg-secondary/10 text-foreground font-semibold rounded-xl hover:bg-secondary/20 active:scale-[0.98] transition-all duration-200 text-sm tracking-wide uppercase"
          >
            Back to Menu
          </Link>
        </div>
