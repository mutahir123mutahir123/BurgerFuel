    ...
    <>
      ...
      >
        ...
        {items.length === 0 ? (
          ...
          <>
            {/* Items List */}
            <div className="flex-1 min-h-0 overflow-y-auto px-4 py-4 space-y-4 sm:pb-4 pb-24">
              {items.map((item) => (
                <div key={item.id} className="flex gap-3 py-3 border-b border-border last:border-0">
                  {/* Image */}
                  {item.product.image && (
                    <div className="relative w-16 h-16 flex-shrink-0 rounded-md overflow-hidden bg-secondary/10">
                      <Image
                    ...
                    <div className="flex items-center justify-between mt-2">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-7 h-7 flex items-center justify-center rounded border border-border hover:bg-secondary/10 transition-colors cursor-pointer text-sm"
